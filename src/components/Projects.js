...
const projects = [
  {
    id: 1,
    title: 'Seg-Mind: Brain Tumor Analysis',
  ...
  },
  {
    ...
    description: 'LSTM-based stock price prediction model with sentiment analysis integration. Features real-time data processing and visualization dashboard.',
    tech: ['Python', 'LSTM', 'NLP', 'React', 'Flask'],
    icon: <FaChartLine />,
    featured: false,
    filter: 'ai',
    github: '#',
